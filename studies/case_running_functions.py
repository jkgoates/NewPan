...
def run_newpan(input_filename, delete_input=True, run=True):
    """Runs NewPan with the given input and returns the report if NewPan generated one."""

    # Run
    if run:
        sp.run(["./newpan.exe", input_filename])
